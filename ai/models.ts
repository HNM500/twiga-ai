...
export const PROVIDERS: Record<ModelProvider, ProviderInfo> = {
  scira: { id: 'scira', name: 'Twiga', icon: 'scira' },
...
const upstreamModels: Model[] = [
  ...
  },
  {
    value: 'scira-default',
    label: 'Twiga',
    description: 'Automatically selected by Twiga through OpenRouter',
    vision: true,
    reasoning: false,
    experimental: false,
    category: 'Free',
...
// Twiga deliberately exposes one model identity. Provider/model selection is a
// server-side product decision rather than an end-user configuration surface.
export const models: Model[] = upstreamModels.filter((model) => model.value === 'scira-default');
