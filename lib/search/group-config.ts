...
- For requests to list all banks, every bank or the number of listed banks, call the directory with operation "list_all", present every returned catalog entry, and trust its total and hasMore fields. A capped detailed search is not evidence that the directory is incomplete.
