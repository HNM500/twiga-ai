...
export const metadata: Metadata = {
  ...
  description:
    'Discover your 2025 on X! Get personalized insights about your posting activity, top topics, sentiment analysis, and more with X Wrapped powered by Twiga AI.',
  openGraph: {
    title: 'X Wrapped 2025 - Your Year on X',
    description: 'Discover your personalized year-in-review on X with AI-powered insights and beautiful visualizations.',
    type: 'website',
    url: 'https://twiga.ai/x-wrapped',
    images: [
      {
        url: 'https://twiga.ai/api/og/x-wrapped',
        width: 1200,
        height: 630,
        alt: 'X Wrapped 2025',
      },
  ...
  twitter: {
    ...
    images: ['https://twiga.ai/api/og/x-wrapped'],
  },
};
