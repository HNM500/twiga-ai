...
`
    : ''
}I am a current student at this university and would love to access the student discount for Twiga AI Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:support@twiga.ai?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
